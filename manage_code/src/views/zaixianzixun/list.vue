			...
			<div class="list_search_view">
				<el-form :model="searchQuery" class="search_form" >
					...
					<div class="search_view">
						...
						<div class="search_box">
							<el-input class="search_inp" v-model="searchQuery.fangwujiagestart" placeholder="最小房屋价格"
								clearable>
							</el-input>至
							<el-input class="search_inp" v-model="searchQuery.fangwujiageend" placeholder="最大房屋价格"
								clearable>
							</el-input>
						</div>
					</div>
...
<script setup>
	...
	const getList = () => {
		...
		if(searchQuery.value.fangwujiagestart){
			params['fangwujiagestart'] = searchQuery.value.fangwujiagestart
		}
		if(searchQuery.value.fangwujiageend){
			params['fangwujiageend'] = searchQuery.value.fangwujiageend
		}
		context?.$http({
			url: `${tableName}/page`,
			method: 'get',
	...
	const approvalClick = (row) => {
		let params = {
			...
			maijiadianhua: row.maijiadianhua,
